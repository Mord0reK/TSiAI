                    ...
                    <div class="form-floating mb-3">
                        <?php if ($blad_szef != ""): ?>
                            <select class="form-select mb-3 <?php if ($blad != ""): ?> is-invalid <?php endif; ?>" name="szef" id="floatingSelectSzef" aria-label="Default select example">
                                ...
                                {
                                    if ($row['ID_PRAC'] == $pracownik['ID_SZEFA'])
                                    {
                                        echo '<option value="' . $row['ID_PRAC'] . '" selected>' . htmlspecialchars($row['NAZWA']) . '</option>';
                                    }
                                    else
                                    {
                                        echo '<option value="'  . $row['ID_PRAC'] . '">' . htmlspecialchars($row['NAZWA']) . '</option>';
                                    }
                                }
                            ?>
                            </select>
                        ...
                        <?php if ($blad_zespol != ""): ?>
                            <select class="form-select mb-3 <?php if ($blad != ""): ?> is-invalid <?php endif; ?> " name="zespol" id="zespol">
                                ...
                                foreach ($zespoly as $row) {
                                    if ($row['ID_ZESP'] == $pracownik['ID_ZESP']) {
                                        echo '<option value="' . $row['ID_ZESP'] . '" selected>' . htmlspecialchars($row['NAZWA']) . '</option>';
                                    } else {
