...
foreach ($etaty as $row) {
    $html .= '<option value="' . safe_display($row['NAZWA']) . '" data-placa-od="' . safe_display($row['PLACA_OD']) . '" data-placa-do="' . safe_display($row['PLACA_DO']) . '">' . safe_display($row['NAZWA']) . '</option>';
}
$html .= '</select>';
...
foreach ($szefy as $row) {
    $html .= '<option value="' . safe_display($row['ID_PRAC']) . '">' . safe_display($row['NAZWA']) . '</option>';
}
$html .= '</select>';
...
foreach ($zespoly as $row) {
    $html .= '<option value="' . safe_display($row['ID_ZESP']) . '">' . safe_display($row['NAZWA']) . '</option>';
}
$html .= '</select>';
